...
#print("generate_surface_mass_density_plot ran successfully")
...
#generate_vertical_feh_mgfe_profile_plot(simpath, snum, spcs, 8, 16, z_cut)
#print("generate_vertical_feh_mgfe_profile_plot ran successfully")
#generate_azim_avgd_met_grad_plot(simpath, snum, spcs, 8, 16, z_cut, minval_mgfe, maxval_mgfe)
#print("generate_azim_avgd_met_grad_plot ran successfully")
#generate_data_model_residual_plot(simpath, snum, spcs, 8, 16, z_cut, minval_feh, maxval_feh)
#print("generate_data_model_residual_plot ran successfully")
#generate_vertical_acceleration_profiles_plot(simpath, snum, spcs, 8, 16, z_cut)
#print("generate_vertical_acceleration_profiles_plot ran successfully")
generate_normalized_residuals_plot(simpath, snum, spcs, 8, 16, z_cut)
print("generate_normalized_residuals_plot ran successfully")
#generate_stellar_smd_plot(simpath, snum, spcs, 8, 16, z_cut, minval_feh, maxval_feh)
...
#generate_vertical_density_profiles_plot(simpath, snum, 'all', 8, 16, 2.5, 10) #change 10 to 5
#print("generate_vertical_density_profiles_plot ran successfully")
#generate_asymmetry_figofmer(simpath, snum, 'all', 8, 16, 2.5, 10, [0, 1, 2, 11, 12, 13, 14, 15]) #change 10 to 5
#print("generate_asymmetry_figofmer ran successfully")
#print("all functions ran successfully")
#compute_smd_stats(simpath, snum, spcs, 8, 16, max_z_cut)
#print("compute_smd_stats ran successfully")